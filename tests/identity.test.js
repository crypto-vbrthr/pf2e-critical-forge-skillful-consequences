...
test("overlap review records the skill/action boundary", () => {
  ...
  for (const phrase of ["Critical Forge Core", "Goblin Engineering", "Martial Consequences", "Grapple", "Trip", "Shove", "Reposition", "Disarm", "Climb", "Swim", "High Jump", "Long Jump", "Balance", "Tumble Through", "Maneuver in Flight", "Squeeze", "skillCheckCriticalSuccess", "skillCheckCriticalFailure"]) {
